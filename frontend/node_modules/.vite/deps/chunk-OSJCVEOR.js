...
var Campaign = class {
  ...
  async create() {
    ...
    const body = {
      ...
      channel_template: (_e = this.data) == null ? void 0 : _e.channel_template,
      create_channels: (_f = this.data) == null ? void 0 : _f.create_channels,
      show_channels: (_g = this.data) == null ? void 0 : _g.show_channels,
      description: (_h = this.data) == null ? void 0 : _h.description,
      name: (_i = this.data) == null ? void 0 : _i.name,
      skip_push: (_j = this.data) == null ? void 0 : _j.skip_push,
      skip_webhook: (_k = this.data) == null ? void 0 : _k.skip_webhook,
      user_ids: (_l = this.data) == null ? void 0 : _l.user_ids
    };
...
var messagePaginationCreatedAtAround = ({
  ...
  if (wholePageHasNewerMessages) {
    ...
    const [firstPageMsgIsFirstInSet, lastPageMsgIsLastInSet] = [
      (firstPageMsg == null ? void 0 : firstPageMsg.id) && firstPageMsg.id === ((_a = parentSet.messages[0]) == null ? void 0 : _a.id),
      (lastPageMsg == null ? void 0 : lastPageMsg.id) && lastPageMsg.id === ((_b = parentSet.messages.slice(-1)[0]) == null ? void 0 : _b.id)
    ];
...
var messagePaginationIdAround = ({
  ...
  const [firstPageMsg, lastPageMsg] = [returnedPage[0], returnedPage.slice(-1)[0]];
  const [firstPageMsgIsFirstInSet, lastPageMsgIsLastInSet] = [
    (firstPageMsg == null ? void 0 : firstPageMsg.id) === ((_a = parentSet.messages[0]) == null ? void 0 : _a.id),
    (lastPageMsg == null ? void 0 : lastPageMsg.id) === ((_b = parentSet.messages.slice(-1)[0]) == null ? void 0 : _b.id)
  ];
...
var AttachmentManager = class {
  constructor({ composer, message }) {
    ...
    this.getAttachmentIndex = (localId) => this.attachments.findIndex(
      (attachment) => {
        var _a;
        return attachment.localMetadata.id && localId === ((_a = attachment.localMetadata) == null ? void 0 : _a.id);
      }
    );
    ...
    this.removeAttachments = (localAttachmentIds) => {
      this.state.partialNext({
        attachments: this.attachments.filter(
          (att) => {
            var _a;
            return !localAttachmentIds.includes((_a = att.localMetadata) == null ? void 0 : _a.id);
          }
        )
      });
    };
    ...
    this.ensureLocalUploadAttachment = async (attachment) => {
      var _a;
      if (!((_a = attachment.localMetadata) == null ? void 0 : _a.file) || !attachment.localMetadata.id) {
    ...
    handlers: {
      ...
      handleFieldBlur: ({
        ...
        const { newData, newErrors } = universalHandler(
          state,
          finalValidators,
          customProcessors == null ? void 0 : customProcessors.handleFieldBlur
        );
        return next({
          ...state,
          nextState: {
      ...
      const result = await this.compositionMiddlewareExecutor.execute({
        ...
        initialValue: {
          data: {
            ...
            options: (_a = data.options) == null ? void 0 : _a.filter((o) => o.text).map((o) => ({ text: o.text }))
          },
          errors
        }
      });
...
var createCompositionDataCleanupMiddleware = (composer) => ({
  ...
  handlers: {
    compose: ({
      ...
      var _a, _b, _c;
      const common = {
        type: ((_a = composer.editedMessage) == null ? void 0 : _a.type) ?? "regular"
      };
...
var createCompositionValidationMiddleware = (composer) => ({
  ...
  handlers: {
    compose: async ({
      ...
      const isEmptyMessage = textIsEmpty(inputText) && !((_a = state.message.attachments) == null ? void 0 : _a.length) && !state.message.poll_id;
...
var createCommandsMiddleware = (channel, options) => {
  ...
  if (options == null ? void 0 : options.searchSource) {
...
var TextComposer = class {
  constructor({ composer, message }) {
    this.initState = ({ message: message2 } = {}) => {
      this.state.next(initState4({ composer: this.composer, message: message2 }));
    };
...
var noop3 = () => void 0;
var _MessageComposer = class _MessageComposer2 {
  constructor({
    composition,
    config,
    compositionContext,
    ...
    this.initState = ({
      ...
      this.state.next(initState5(composition2));
    ...
    this.subscribeMessageUpdated = () => {
      ...
      const unsubscribeFunctions = eventTypes.map(
        (eventType) => this.client.on(eventType, (event) => {
          ...
          if (((_a = this.quotedMessage) == null ? void 0 : _a.id) && event.message.id === this.quotedMessage.id) {
    ...
    this.subscribeTextComposerStateChanged = () => this.textComposer.state.subscribe((nextValue, previousValue) => {
      if (previousValue && nextValue.text !== (previousValue == null ? void 0 : previousValue.text)) {
      ...
      if (!this.linkPreviewsManager.enabled || nextValue.text === (previousValue == null ? void 0 : previousValue.text))
        return;
      if (!nextValue.text) {
    ...
    this.compose = async () => {
      var _a;
      const created_at = ((_a = this.editedMessage) == null ? void 0 : _a.created_at) ?? /* @__PURE__ */ new Date();
      const text = "";
      const result = await this.compositionMiddlewareExecutor.execute({
        eventName: "compose",
        initialValue: {
    ...
    this.createPoll = async () => {
      ...
      try {
        const { poll } = await this.client.createPoll(composition2.data);
...
var Channel = class {
  ...
  _isTypingIndicatorsEnabled() {
    var _a, _b, _c, _d;
    if (!((_a = this.getConfig()) == null ? void 0 : _a.typing_events)) {
      return false;
    }
    return ((_d = (_c = (_b = this.getClient().user) == null ? void 0 : _b.privacy_settings) == null ? void 0 : _c.typing_indicators) == null ? void 0 : _d.enabled) ?? true;
  }
  /**
  ...
  async query(options = {}, messageSetToAddToIfDoesNotExist = "current") {
    ...
    await this.getClient().wsPromise;
    const createdById = ((_a = options.created_by) == null ? void 0 : _a.id) ?? options.created_by_id ?? ((_c = (_b = this._data) == null ? void 0 : _b.created_by) == null ? void 0 : _c.id) ?? ((_d = this._data) == null ? void 0 : _d.created_by_id);
    ...
    messageSet.pagination = {
      ...
      ...messageSetPagination({
        ...
        messagePaginationOptions: options == null ? void 0 : options.messages,
        requestedPageSize: ((_e = options == null ? void 0 : options.messages) == null ? void 0 : _e.limit) ?? DEFAULT_QUERY_CHANNEL_MESSAGE_LIST_PAGE_SIZE,
    ...
    const areCapabilitiesChanged = [...state.channel.own_capabilities || []].sort().join() !== [
      ...this.data && Array.isArray((_f = this.data) == null ? void 0 : _f.own_capabilities) ? this.data.own_capabilities : []
    ].sort().join();
    this.data = state.channel;
    this.offlineMode = false;
    if (areCapabilitiesChanged) {
    ...
    switch (event.type) {
      ...
      case "message.read":
        if (((_c = event.user) == null ? void 0 : _c.id) && event.created_at) {
          ...
          if (((_d = event.user) == null ? void 0 : _d.id) === ((_e = this.getClient().user) == null ? void 0 : _e.id)) {
      ...
      case "user.updated":
        if ((_f = event.user) == null ? void 0 : _f.id) {
          channelState.watchers[event.user.id] = event.user;
        }
        break;
      case "user.watching.stop":
        if ((_g = event.user) == null ? void 0 : _g.id) {
      ...
      case "message.new":
        if (event.message) {
          const ownMessage = ((_h = event.user) == null ? void 0 : _h.id) === ((_i = this.getClient().user) == null ? void 0 : _i.id);
      ...
      case "channel.truncated":
        if ((_k = event.channel) == null ? void 0 : _k.truncated_at) {
      ...
      case "member.updated": {
        ...
        if (typeof currentUserId === "string" && typeof ((_l = memberCopy == null ? void 0 : memberCopy.user) == null ? void 0 : _l.id) === "string" && memberCopy.user.id === currentUserId) {
      ...
      case "notification.mark_unread": {
        const ownMessage = ((_n = event.user) == null ? void 0 : _n.id) === ((_o = this.getClient().user) == null ? void 0 : _o.id);
      ...
      case "channel.updated":
        if (event.channel) {
          const isFrozenChanged = ((_p = event.channel) == null ? void 0 : _p.frozen) !== void 0 && event.channel.frozen !== ((_q = channel.data) == null ? void 0 : _q.frozen);
          if (isFrozenChanged) {
            this.query({ state: false, messages: { limit: 0 }, watchers: { limit: 0 } });
          }
          channel.data = {
            ...event.channel,
            hidden: ((_r = event.channel) == null ? void 0 : _r.hidden) ?? ((_s = channel.data) == null ? void 0 : _s.hidden),
            own_capabilities: ((_t = event.channel) == null ? void 0 : _t.own_capabilities) ?? ((_u = channel.data) == null ? void 0 : _u.own_capabilities)
          };
        }
        break;
      case "reaction.new":
      ...
      case "channel.visible":
        ...
        break;
      case "user.banned":
        if (!((_v = event.user) == null ? void 0 : _v.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: !!event.shadow,
          banned: !event.shadow,
          user: { ...((_w = channelState.members[event.user.id]) == null ? void 0 : _w.user) || {}, ...event.user }
        };
        break;
      case "user.unbanned":
        if (!((_x = event.user) == null ? void 0 : _x.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: false,
          banned: false,
          user: { ...((_y = channelState.members[event.user.id]) == null ? void 0 : _y.user) || {}, ...event.user }
        };
        break;
      default:
    }
    ...
    this.castVote = async (optionId, messageId) => {
      ...
      if (reachedVoteLimit) {
        ...
        Object.values(ownVotesByOptionId).slice(1).forEach((vote) => {
          if (!(oldestVote == null ? void 0 : oldestVote.created_at) || new Date(vote.created_at) < new Date(oldestVote.created_at)) {
            oldestVote = vote;
          }
        });
        if (oldestVote == null ? void 0 : oldestVote.id) {
    ...
    this.queryChannels = async (filters, sort = [], options2 = {}, stateOptions = {}) => {
      ...
      try {
        ...
        this.state.partialNext({
          ...
          pagination: {
            ...pagination,
            hasNext: ((channels == null ? void 0 : channels.length) ?? 0) >= limit,
            isLoading: false,
            options: newOptions
          },
          initialized: true
    ...
    this.loadNext = async () => {
      ...
      try {
        ...
        this.state.partialNext({
          ...
          pagination: {
            ...pagination,
            hasNext: ((nextChannels == null ? void 0 : nextChannels.length) ?? 0) >= limit,
            isLoading: false,
            isLoadingNext: false,
            options: newOptions
          }
...
var StreamChat = class _StreamChat {
  constructor(key, secretOrOptions, options) {
    ...
    this.createChannelManager = ({
      eventHandlerOverrides = {},
      options: options2 = {}
    }) => new ChannelManager({ client: this, eventHandlerOverrides, options: options2 });
    this.openConnection = () => {
      var _a2, _b, _c;
      if (!this.userID) {
        throw Error(
    ...
    this._deleteUserMessageReference = (user, hardDelete = false) => {
      ...
      for (const channelID in refMap) {
        ...
        if (channel) {
          const state = channel.state;
          state == null ? void 0 : state.deleteUserMessages(user, hardDelete);
        }
      }
    };
    ...
    this.notifications = (options == null ? void 0 : options.notifications) ?? new NotificationManager();
  ...
  */
  ...
  _enrichAxiosOptions(options = {
    ...
    if (!((_a = options.headers) == null ? void 0 : _a["x-client-request-id"])) {
      options.headers = {
        ...options.headers,
  ...
  getCampaign(id, options) {
    this.validateServerSideAuth();
    return this.get(this.baseURL + `/campaigns/${encodeURIComponent(id)}`, { ...options == null ? void 0 : options.users });
  }
  startCampaign(id, options) {
    this.validateServerSideAuth();
    return this.post(this.baseURL + `/campaigns/${encodeURIComponent(id)}/start`, {
      scheduled_for: options == null ? void 0 : options.scheduledFor,
      stop_at: options == null ? void 0 : options.stopAt
    });
  }
  /**
...
var FixedSizeQueueCache = class {
  constructor(size, options) {
    ...
    this.dispose = (options == null ? void 0 : options.dispose) ?? null;
  }
  /**
...
//# sourceMappingURL=chunk-OSJCVEOR.js.map
